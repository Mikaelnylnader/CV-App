...
export default function CoverLetterPage() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <Sidebar currentPage="Cover Letter" />
        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-8 rounded-xl mb-8">
            ...
            <p className="text-xl text-blue-100">
              Create professional, personalized cover letters in minutes using advanced AI technology
            </p>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-blue-50 p-6 rounded-lg transform transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-br hover:from-blue-50 hover:to-white group">
              ...
              <p className="text-sm text-gray-600 group-hover:text-gray-700">Receive your customized cover letter</p>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                    (loading || !file || !jobUrl) ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
                >
                  {loading ? (
                    <>
